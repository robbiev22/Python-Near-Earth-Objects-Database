...
class NearEarthObject:
    ...
    def __str__(self):
        ...
        return f"The NearEarthObject {self.fullname} has a diameter of {self.diameter:.2f} km " \
    ...
    def serialize(self):
        """Serialize `NearEarthObject`.

        :return: a dict containing all attributes values of the instance
        """
...
class CloseApproach:
    ...
    def __init__(self, **info):
        ...
        self.time = cd_to_datetime(info['time'])  # DONE: Use the cd_to_datetime function for this attribute.
        try:
    ...
    def __str__(self):
        ...
        # The project instructions include one possibility. Peek at the __repr__
        # method for examples of advanced string formatting.
        return f"At {self.time_str} the NEO {self.neo.fullname} will approach earth at a distance of {self.distance:.2f} and a velocity of {self.velocity:.2f}"
